  ...
  return (
    <div data-dev="mock-actor-switcher" className="flex flex-wrap items-center justify-center gap-x-3 gap-y-2">
          ...
          {uniqueParties.map((party) => {
            ...
            return (
              <button
                ...
                aria-pressed={active}
                className={cn(
                  "inline-flex cursor-pointer items-center justify-center gap-2 rounded-full px-4 py-2 text-sm font-semibold transition-all",
                  isMaria
                    ? active
                      ? "bg-orange-100 text-orange-700 shadow-sm"
                      : "bg-neutral-50 text-orange-600 hover:bg-orange-50"
                    : active
                      ? "border border-zinc-500/[0.12] bg-neutral-950 text-white shadow-sm"
                      : "border border-zinc-500/[0.12] bg-white text-neutral-700 hover:-translate-y-px hover:shadow-sm",
                )}
              >
      ...
      <button
        ...
        className="ml-auto inline-flex cursor-pointer items-center gap-1.5 rounded-full border border-dashed border-zinc-500/[0.25] px-3 py-1 text-xs font-semibold text-neutral-500 transition-all hover:-translate-y-px hover:border-red-300 hover:text-red-600"
      >
